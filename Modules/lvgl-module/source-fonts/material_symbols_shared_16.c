...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    /* U+E02B "" */
    0x0, 0x5, 0x0, 0x14, 0xb, 0xe0, 0x7, 0x43,
    0x5c, 0x0, 0xb4, 0x87, 0x0, 0xb, 0x41, 0xc0,
    0x0, 0x74, 0x70, 0x0, 0x17, 0x40, 0x40, 0x1c,
    0x74, 0x38, 0x3, 0x47, 0x4c, 0x0, 0x79, 0xfc,
    0x0, 0x6, 0xff, 0x40, 0x0, 0x28, 0x74, 0x0,
    0xa, 0x7, 0x40, 0x0, 0x0, 0x60,

    /* U+E04F "" */
    0x90, 0x0, 0x10, 0x1e, 0x1, 0xf, 0x1, 0xe1,
    0xc0, 0xf0, 0x1e, 0x10, 0xd, 0x3f, 0xe0, 0xa2,
    0xce, 0x5e, 0x2c, 0x73, 0x91, 0xe1, 0x1c, 0xff,
    0x7e, 0xb, 0x0, 0xfd, 0xe1, 0x40, 0xf, 0x1e,
    0x0, 0x0, 0x47, 0xe0, 0x0, 0x0, 0x5d, 0x0,
    0x0, 0x1, 0x80,

    /* U+E050 "" */
    0x0, 0x0, 0x40, 0x0, 0x10, 0xf0, 0x0, 0xf0,
    0x3c, 0x3, 0xf0, 0xd, 0xff, 0x72, 0x8b, 0xe4,
    0x72, 0xc7, 0xe4, 0x72, 0xc7, 0xff, 0x72, 0x8b,
    0x3, 0xf0, 0xd, 0x0, 0xf0, 0x3c, 0x0, 0x11,
    0xf0, 0x0, 0x0, 0x40,
    ...
    /* U+E31D "" */
    0x0, 0x50, 0x0, 0x2f, 0x80, 0x3, 0x5c, 0x0,
    0x35, 0xc0, 0x3, 0x5c, 0x0, 0x35, 0xc0, 0x53,
    0x5c, 0x57, 0x2f, 0x8d, 0x38, 0x2, 0xc1, 0xe5,
    0xb4, 0x2, 0xf8, 0x0, 0xa, 0x0, 0x0, 0xa0,
    0x0,
    ...
    0xff, 0x0, 0x1e, 0xfd, 0x0, 0x78, 0xb4, 0x1,
    0xe2, 0xd0, 0x7, 0x8b, 0x40, 0x1e, 0x2d, 0x0,
    0x78, 0xb4, 0x0, 0xe2, 0xd0, 0x0, 0xeb, 0x40,
    0x0, 0xfd, 0x0, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 46, .adv_w = 256, .box_w = 13, .box_h = 13, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 89, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 125, .adv_w = 256, .box_w = 10, .box_h = 10, .ofs_x = 3, .ofs_y = 3},
    {.bitmap_index = 150, .adv_w = 256, .box_w = 14, .box_h = 12, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 192, .adv_w = 256, .box_w = 9, .box_h = 14, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 224, .adv_w = 256, .box_w = 10, .box_h = 14, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 259, .adv_w = 256, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 323, .adv_w = 256, .box_w = 14, .box_h = 12, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 365, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 414, .adv_w = 256, .box_w = 8, .box_h = 5, .ofs_x = 4, .ofs_y = 6},
    {.bitmap_index = 424, .adv_w = 256, .box_w = 10, .box_h = 13, .ofs_x = 3, .ofs_y = 2},
    {.bitmap_index = 457, .adv_w = 256, .box_w = 14, .box_h = 12, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 499, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 535, .adv_w = 256, .box_w = 8, .box_h = 12, .ofs_x = 4, .ofs_y = 2},
    {.bitmap_index = 559, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 595, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 631, .adv_w = 256, .box_w = 10, .box_h = 10, .ofs_x = 3, .ofs_y = 3},
    {.bitmap_index = 656, .adv_w = 256, .box_w = 12, .box_h = 8, .ofs_x = 2, .ofs_y = 4},
    {.bitmap_index = 680, .adv_w = 256, .box_w = 4, .box_h = 12, .ofs_x = 6, .ofs_y = 2},
    {.bitmap_index = 692, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 728, .adv_w = 256, .box_w = 16, .box_h = 12, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 776, .adv_w = 256, .box_w = 12, .box_h = 8, .ofs_x = 2, .ofs_y = 4},
    {.bitmap_index = 800, .adv_w = 256, .box_w = 13, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 839, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 875, .adv_w = 256, .box_w = 12, .box_h = 14, .ofs_x = 2, .ofs_y = 1},
    {.bitmap_index = 917, .adv_w = 256, .box_w = 14, .box_h = 13, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 963, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 1012, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 1061, .adv_w = 256, .box_w = 10, .box_h = 14, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 1096, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 1132, .adv_w = 256, .box_w = 14, .box_h = 12, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 1174, .adv_w = 256, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1238, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 1274, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 1323, .adv_w = 256, .box_w = 14, .box_h = 13, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 1369, .adv_w = 256, .box_w = 12, .box_h = 14, .ofs_x = 2, .ofs_y = 1},
    {.bitmap_index = 1411, .adv_w = 256, .box_w = 12, .box_h = 14, .ofs_x = 2, .ofs_y = 1},
    {.bitmap_index = 1453, .adv_w = 256, .box_w = 13, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 1492, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 1541, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 1577, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 1613, .adv_w = 256, .box_w = 16, .box_h = 12, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 1661, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 1697, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 1733, .adv_w = 256, .box_w = 16, .box_h = 12, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 1781, .adv_w = 256, .box_w = 12, .box_h = 14, .ofs_x = 2, .ofs_y = 1},
