...
int main(int argc, char** argv) {
    ...
    BaseType_t task_result = xTaskCreate(
        test_task,
        "test_task",
        // Larger than the other test suites use: Lua's parser and its VM both recurse,
        // so compiling and running a chunk needs noticeably more stack than a flat C API.
        32768,
        &data,
        1,
        nullptr
