...
#define TAG "jc8048w550c_bootstrap"
...
static bool init_i2c() {
    ...
    if (i2c_param_config(JC8048W550_TOUCH_I2C_PORT, &i2c_conf) != ESP_OK) {
        TT_LOG_E(TAG, LOG_MESSAGE_I2C_INIT_CONFIG_FAILED );
        return false;
    }

    if (i2c_driver_install(JC8048W550_TOUCH_I2C_PORT, i2c_conf.mode, 0, 0, 0) != ESP_OK) {
...
static bool init_spi() {
    ...
    const spi_bus_config_t bus_config = {
        .mosi_io_num = JC8048W550_SPI3_PIN_MOSI,
        .miso_io_num = JC8048W550_SPI3_PIN_MISO,
        .sclk_io_num = JC8048W550_SPI3_PIN_SCLK,
        ...
        .data6_io_num = 0,
        .data7_io_num = 0,
        .max_transfer_sz = JC8048W550_SPI3_TRANSACTION_LIMIT,
        .flags = 0,
