...
#define TAG "jc2432w328c_bootstrap"
...
static bool init_i2c() {
    ...
    if (i2c_param_config(JC2432W328C_TOUCH_I2C_PORT, &i2c_conf) != ESP_OK) {
        TT_LOG_E(TAG, LOG_MESSAGE_I2C_INIT_CONFIG_FAILED );
        return false;
    }

    if (i2c_driver_install(JC2432W328C_TOUCH_I2C_PORT, i2c_conf.mode, 0, 0, 0) != ESP_OK) {
...
static bool init_spi2() {
    ...
    const spi_bus_config_t bus_config = {
        .mosi_io_num = JC2432W328C_SPI2_PIN_MOSI,
        .miso_io_num = GPIO_NUM_NC,
        .sclk_io_num = JC2432W328C_SPI2_PIN_SCLK,
        .quadwp_io_num = GPIO_NUM_NC,
        .quadhd_io_num = GPIO_NUM_NC,
        .max_transfer_sz = JC2432W328C_SPI2_TRANSACTION_LIMIT
   };
...
static bool init_spi3() {
    ...
    const spi_bus_config_t bus_config = {
        .mosi_io_num = JC2432W328C_SPI3_PIN_MOSI,
        .miso_io_num = JC2432W328C_SPI3_PIN_MISO,
        .sclk_io_num = JC2432W328C_SPI3_PIN_SCLK,
        .quadwp_io_num = GPIO_NUM_NC,
        .quadhd_io_num = GPIO_NUM_NC,
        .data4_io_num = 0,
        .data5_io_num = 0,
        .data6_io_num = 0,
        .data7_io_num = 0,
        .max_transfer_sz = JC2432W328C_SPI3_TRANSACTION_LIMIT,
        .flags = 0,
